package com.ets.business.timertask.task;
...
public class Task {
	...
	public void runBalance(String paras) {
		...
		try {
			...
			List<nb_watermeter_equipment> list = equipmentService.getEquipmentList(customercode);
	...
	public void optionBalanceObject(nb_watermeter_equipment watermeter) throws Exception {
		...
		nb_balance_dict balance = new nb_balance_dict();
